        ...
        $(function(e) {
            ...
            $('#deleteAllSelectedRecord').click(function(e) {
                ...
                if (all_ids.length > 0) {
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    Swal.fire('Deleted!',
                                        'User Berhasil Di Hapus', 'success');
                                },
                    ...
                    Swal.fire('Tidak ada User yang dipilih!',
                        'Silakan pilih setidaknya satu User untuk dihapus.', 'info');
                }
            });
