                    ...
                    @foreach ($permissions as $permission)
                        <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700" id="permissions_ids{{ $permission->id}}">
                            ...
                            <td class="px-6 py-4 text-center flex justify-center items-center">
                                ...
                                <form id="deleteForm{{ $permission->id }}" action="{{ route('permissions.destroy', $permission->id) }}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="button"
        ...
        $(function(e){
            ...
            $('#deleteAllSelectedRecord').click(function(e) {
                ...
                if (all_ids.length > 0) {
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                success: function(response) {
                                    ...
                                    Swal.fire('Deleted!',
                                        'Permission Berhasil Di Hapus', 'success'
                                        );
                                },
                    ...
                    Swal.fire('Tidak ada Permission yang dipilih!', 'Silakan pilih setidaknya satu Permission untuk dihapus.',
                        'info');
                }
            });
