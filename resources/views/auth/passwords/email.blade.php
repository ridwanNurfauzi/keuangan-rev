...
@section('content')
    <div class="container">
        ...
        @endif
        <div class="flex flex-col items-center justify-center px-6 py-8 mt-20 mx-auto lg:py-0">
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('password.email') }}">
                        ...
                        <button type="submit"
                            class="w-full text-white bg-blue-600 hover:bg-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Kirim tautan pengaturan ulang kata sandi</button>
                    </form>
                </div>
            </div>
        </div>
